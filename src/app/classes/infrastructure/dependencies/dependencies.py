...
from src.app.classes.infrastructure.controllers.get_class import GetClassController
...
def init_dependencies_class():
    ...
    get_class_usecase    = GetClass(repo)
    ...
    get_class_controller    = GetClassController(get_class_usecase)
    ...
    return {
        ...
        "get_class_controller"    : get_class_controller
    }
